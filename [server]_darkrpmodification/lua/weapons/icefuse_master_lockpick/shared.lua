...
File Path:   addons/[server]_darkrpmodification/lua/weapons/icefuse_master_lockpick/shared.lua
...
if CLIENT then
	SWEP.PrintName = "Master Lockpick"
	SWEP.Slot = 5
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = false
...
function SWEP:PrimaryAttack()
	...
	if SERVER then
		...
		self.LockPickTime = math.Rand(10, 15)
