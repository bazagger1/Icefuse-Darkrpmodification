...
File Path:   addons/[server]_darkrpmodification/lua/weapons/keys/cl_menu.lua
...
local function AddButtonToFrame(Frame)
    ...
    button:SetFont( "F2_Butt" )

    button.Paint = function( pnl, w, h )

        draw.RoundedBox( 10, 0, 0, w, h, Color( 10, 10, 10, 210 ))

        draw.RoundedBox( 1, 0, 0, w, 1, Color( 255, 255, 255, 150 ))
        draw.RoundedBox( 1, 0, 0, 1, h, Color( 255, 255, 255, 150 ))
        draw.RoundedBox( 1, 0, h-1, w, 1, Color( 255, 255, 255, 150 ))
        draw.RoundedBox( 1, w-1, 0, 1, h, Color( 255, 255, 255, 150 ))
    end
...
local function openMenu(setDoorOwnerAccess, doorSettingsAccess)
    ...
    Frame.Paint = function( pnl, w, h )
        ...
        draw.RoundedBox( 0, 0, 0, w, h, Color( 10, 10, 10, 110 ))
